...
#ifndef APP_CNETPROTOCAL_H
#define APP_CNETPROTOCAL_H
...
public:
    ...
    APP_FORCE_INLINE void* getUserPointer() const {
        return mUserPointer;
    }
   ...
   */
    ...
    */
    ...
    /**
    *@brief Write raw data(eg. UDP packet) into CNetProtocal.
...
private:
    ...
    u32 mSendQueueCount;
    CQueueNode mQueueSend;
    CQueueNode mQueueReceive;
    CQueueNode mQueueSendBuffer;
    CQueueNode mQueueReceiveBuffer;
